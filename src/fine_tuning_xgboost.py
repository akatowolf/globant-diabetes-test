...
class FineTuningPipeline:
    ...
    def save_confusion_matrix(self, y_true, y_pred, filename='confusion_matrix.png'):
    ...
    def save_feature_importances(self, model, X, filename='feature_importances.csv'):
        ...
        print(f"Feature importances saved as {filename}")
    ...
    def run(self):
        ...
        with mlflow.start_run(run_name="Fine-Tuned_XGBoost"):
            ...
            self.save_confusion_matrix(y_val, y_val_pred, filename='confusion_matrix.png')
            self.save_feature_importances(best_model, X_val, filename='feature_importances.csv')
            ...
            print(f"Confusion Matrix and Feature Importances have been saved.")
